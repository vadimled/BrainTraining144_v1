...
const loginReducer = createReducer(initialState, {
  ...
  [types.SET_EMAIL_LOGIN]: (state, { payload }) => {
    return {
      ...state,
      model: { ...state.model, email: payload }
    };
  },
  [types.SET_PASSWORD_LOGIN]: (state, { payload }) => {
    return {
      ...state,
  ...
  [types.SET_LOGIN_ERROR]: (state, { payload }) => {
    return {
      ...state,
      loginErrors: { ...state.loginErrors, ...{ [payload]: payload } }
    };
  },
  [types.CLEAN_LOGIN_ERROR]: (state, { payload }) => {
  ...
  [types.SET_LOGIN_SERVER_ERROR]: (state, { payload }) => {
    return {
      ...state,
      loginServerErrors: { ...payload }
    };
  },
  [types.FETCH_USER_FAILED]: (state, { payload }) => {
    return {
      ...state,
      loginServerErrors: payload
    };
